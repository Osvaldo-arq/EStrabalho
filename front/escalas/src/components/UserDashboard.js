          ...
          <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell align="center">{funcionario.escalas.data}</TableCell>
                <TableCell align="center">{funcionario.escalas.dataFim}</TableCell>
            ...
            <TableBody>
              {entregas.map((entrega) => (
                <TableRow key={entrega.id}>
                  ...
                  <TableCell align="center">{entrega.dataEntrega}</TableCell>
